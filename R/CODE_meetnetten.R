...
meetnetten_sel <-   
  ...
  mutate(popup_tekst = case_when(
    ...
    meetnet_nr == 5 ~ glue("<b>Meetnet bestrijdingsmiddelen</b><br><b>Meetpunt: </b>{mp}<hr><b>Soort metingen:</b> Bestrijdingsmiddelen<br><b>Frequentie: </b>Jaarlijks 4 tot 6 metinge<br><br>Zie ook: {meetpunt_link(mp)}"),
