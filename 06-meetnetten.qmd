...
Om deze rapportage te maken zijn er veel metingen nodig. Die metingen zijn afkomstig van de meetnetten die het waterschap heeft. In dit hoofdstuk vind je informatie over de metingen die het waterschap doet en welke meetnetten het waterschap heeft.
...
In de onderstaande tabel is van elke soort(groep) in detail terug te vinden hoe vaak er waarnemingen zijn gedaan en op hoeveel verschillende locaties.


::: column-body-outset
```{r}
#| label: tabel-biologie
#| fig-cap: "Aantal biologische soortwaarnemingen en meetlocaties in {{< var vorig_jaar >}}. (interactief)"
