...
Waterplanten hebben een sleutelrol in het onderwaterleven (ecosysteem). Ze zorgen voor de productie van zuurstof en vormen het leefgebied voor vissen en andere waterdieren. Door deze sleutelrol geven waterplanten een goede indicatie van de waterkwaliteit en de toestand van het leven onder water. De meeste planten hebben een positieve rol in het ecosysteem. Er zijn echter ook soorten, zoals kroos, die niet zo gunstig voor het water zijn.

Planten die onder water groeien zijn belangrijk voor het onderwaterleven. In de Krimpenerwaard is het aantal locaties met planten onder water[^01-zichtbare-toestand-1] sterk afgenomen. Vooral in de laatste zes jaar is een sterke afname te zien. Het is aannemelijk dat de afname van waterplanten te maken heeft met de opkomst van Amerikaanse rivierkreeften.
...
::: aside
![Een sloot met waterplanten ziet er bijna uit als een aquarium.<br>(foto: Willem Kolvoort)](images/onderwater%20landschap%201%20liggend.jpg){group="toestand"}
:::
...
Kroos[^01-zichtbare-toestand-2] kan hard groeien als er (te) veel voedingsstoffen in het water aanwezig zijn. Kroos drijft op het water en kan grote delen van het water afdekken. Hierdoor is er onvoldoende licht voor andere waterplanten en is er minder zuurstofuitwisseling met de lucht. Als een groot gedeelte van het water met kroos is begroeid heeft dat een negatieve invloed op het water leven. Het aantal wateren met veel kroos is te zien in onderstaande figuur. Het aantal wateren met veel kroos varieert sterk van jaar tot jaar. In de Krimpenerwaard zijn er soms veel meer wateren met veel kroos dan in Schieland. In de laatste 5 jaar is het aantal wateren met veel kroos in de Krimpenerwaard juist opvallend laag.
...
[^01-zichtbare-toestand-3]: Het hoogheemraadschap heeft in 2023 geïnventariseerd waar Amerikaanse kreeften voorkomen. De [rapportage over Amerikaanse Rivierkreeften](https://www.schielandendekrimpenerwaard.nl/kaart/waterkwaliteit/waterkwaliteitsrapportages/kreeften_2023/){target="_blank"} is online te lezen.
...
#| fig-alt: "Kaart met de locaties waar in 2023 kreeften zijn aangetroffen."
kaart_kreeften
```
...
Blauwalgen[^01-zichtbare-toestand-4] zijn geen echte algen maar een bepaalde groep bacteriën (cyanobacteriën) die zich gedragen als algen. Onder voedselrijke omstandigheden kunnen blauwalgen massaal gaan groeien. Hierdoor wordt het water troebel waardoor andere planten niet kunnen groeien. Blauwalgen vormen ook vaak drijflagen die na verloop van tijd afsterven en gaan rotten. Zo'n afstervende drijflaag gaat behoorlijk stinken. Drijflagen van blauwalgen zijn makkelijk te herkennen aan hoe ze eruit zien en soms ook aan de lucht. De aanwezigheid van veel blauwalgen is een aanwijzing dat de waterkwaliteit niet zo goed is.
...
In 2023 zijn er op veel plekken blauwalgen aangetroffen (zie @fig-kaart-blauwalgen ). Op een behoorlijk aantal locaties waren er zelfs veel blauwalgen. In @sec-zwemwater is meer te lezen over wat de gevolgen zijn van blauwalgen voor de zwemwaterkwaliteit.
...
#| out-width: "100%" 
#| fig-cap: "Op welke locaties waren er veel blauwalgen? De kaart is gemaakt op basis van de grootst gemeten hoeveelheid blauwalgen in 2023. De indeling is gemaakt op basis van de risicobeoordeling voor zwemwater. (interactief)"
#| fig-alt: "Kaart met de locaties waarin 2023 veel blauwalgen zijn aangetroffen."
kaart_blauwalgen
```
