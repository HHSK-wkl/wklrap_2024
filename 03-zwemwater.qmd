...
| [{{< fa circle-arrow-up >}}]{.oranje}    | In 2024 waren er meer dagen met een waarschuwing voor blauwalgen dan in de voorgaande drie jaar.                                                                                     |
| [{{< fa circle-exclamation >}}]{.oranje} | Op 3 zwemlocaties hadden mensen in 2023 last van jeukklachten.                                                                                                                       |
...
Als er veel blauwalgen op een zwemlocatie zijn, wordt daarvoor gewaarschuwd. Dat gebeurt met een waarschuwing of als er heel veel blauwalgen zijn met een negatief zwemadvies. Bij een negatief zwemadvies wordt iedereen afgeraden om te zwemmen.[^03-zwemwater-2] In @fig-grafiek-blauwalgen is te zien hoeveel dagen er een waarschuwing van kracht is geweest op de zwemlocaties. In 2024 werd aren er iets meer minder waarschuwingen dan in het voorgaande jaar.
...
Het gebeurt af en toe dat mensen melding maken van jeukklachten na het zwemmen. Jeukklachten worden meestal veroorzaakt door zwemmersjeuk[^03-zwemwater-5]. Als er meerdere meldingen zijn van jeukklachten dan geeft de provincie een waarschuwing af. Het waterschap doet dan aanvullend onderzoek naar zwemmersjeuk, maar zwemmersjeuk is in de praktijk vaak niet aan te tonen.
